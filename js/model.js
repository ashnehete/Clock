...
var MODEL = {
    ...
    gradients: {
        sun: [
            new ColorStop(0xFFFFFF, 0),
            new ColorStop(0xFFFFFF, 0.5),
            new ColorStop(0xFFFFFF, 1)
        ],
        sky: [
            new ColorStop(0x000000, 0),
            new ColorStop(0xFFFFFF, 0.1),
            new ColorStop(0x00FFFF, 0.2),
            new ColorStop(0xFFFFFF, 0.3),
            new ColorStop(0xFDFF76, 0.4),
            new ColorStop(0xFF8b36, 0.5),
            new ColorStop(0x000000, 0.6),
            new ColorStop(0x000000, 1)
        ],
        mount1: [
            new ColorStop(0x000000, 0),
            new ColorStop(0xFFFFFF, 0.5),
