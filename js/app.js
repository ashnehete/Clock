...
//         // sun.position.x = 80 * Math.cos(angleMoon);
//         // sun.position.y = -30/*displaced*/ + (-60 * Math.sin(angleMoon)); // Anti-Clockwise
//
...
(function color() {
    ...
    if (elapsed <= OCTOPUS.getTime()) {
        ...
        // console.log(OCTOPUS.getCurrentColor("sky").getHexString());
